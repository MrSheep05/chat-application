...
-- changeset liquibase:remove_message2 endDelimiter://
CREATE PROCEDURE RemoveMessage2(IN input_connection_id VARCHAR(255), IN input_message_id VARCHAR(36))
BEGIN
    ...
    SELECT ROW_COUNT() 'update_count';
END//
-- rollback DROP PROCEDURE RemoveMessage2
